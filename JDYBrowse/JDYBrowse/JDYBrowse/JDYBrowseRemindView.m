...
@implementation JDYBrowseRemindView
...
- (void)showRemindViewWithText:(NSString *)text
{
    ...
    [_maskView jdy_setFrameInSuperViewCenterWithSize:CGSizeMake(size.width + 20, size.height + 40)];
    [_remindLabel jdy_setFrameInSuperViewCenterWithSize:CGSizeMake(size.width, size.height)];
