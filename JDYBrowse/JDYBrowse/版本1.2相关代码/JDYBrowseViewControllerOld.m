...
#import "JDYBrowseViewControllerOld.h"
...
@interface JDYBrowseViewControllerOld ()
...
@implementation JDYBrowseViewControllerOld
...
- (void)createCollectionView
{
    ...
    [_collectionView registerClass:[JDYBrowseCollectionViewCellOld class] forCellWithReuseIdentifier:@"Browser_Cell"];
...
{
    JDYBrowseCollectionViewCellOld *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"Browser_Cell" forIndexPath:indexPath];
    if(cell)
    {
        // 停止加载
...
// 加载大图
- (void)loadBigImage:(UIImageView *)imageView browseItem:(JDYBrowseModel *)browseItem cell:(JDYBrowseCollectionViewCellOld *)cell
{
    // 加载圆圈显示
...
- (void)tap:(JDYBrowseCollectionViewCellOld *)browseCell
{
    ...
    for (JDYBrowseCollectionViewCellOld *cell in cellArray)
    {
        [cell.loadingView stopAnimation];
    }
